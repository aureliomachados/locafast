...
@section('content')
    <div class="container">
        ...
        <div class="col-md-10 col-md-offset-1">
            <div class="well">
                <h3><b>CONTRATO DE LOCAÇÃO DE AUTOMÓVEL DE PRAZO DETERMINADO</b></h3>
                ...
                <p>
                    ...
                    <p>
                        ...
                        Cláusula 4a. A presente locação terá o lapso temporal de validade de (xxx) dias, iniciando no dia <b>{{ $solicitacao->data_locacao }}</b> e terminando no dia <b>{{ $solicitacao->data_devolucao }}</b>, data na qual o
